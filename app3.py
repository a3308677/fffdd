        ...
        carousel_template_message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    ...
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Lee Sun Hee (이선희)_ Fate (인연 姻缘) [King and the Clown 왕의 남',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Fate/Apocrypha - Karna vs Siegfried | Full Fight カルナVSジーク',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Shirou Kotomine Explained - Fate Apocrypha | PAST u0026 LORE - P',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
