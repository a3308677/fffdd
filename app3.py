...
######################################################################
    ...
    if event.message.text.lower().startswith('測')==True:
        carousel_template_message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/5ecQJhhH2rc/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIhCGAE=&amp;rs=AOn4CLBfYYHtRK2QL5GSbhqQjJrKUPFPeQ',title='Fate Stay Night   Unlimited Blade Works The Movie English Subbed',text='中国云南卫视官方频道 China Yunnan TV Official Channel',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=5ecQJhhH2rc')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Lee Sun Hee (이선희)_ Fate (인연 姻缘) [King and the Clown 왕의 남자 OST] 가사 (Lyrics) [Hangul/Romanization] HD',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Fate/Apocrypha - Karna vs Siegfried | Full Fight カルナVSジークフリート',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Shirou Kotomine Explained - Fate Apocrypha | PAST u0026 LORE - Part 1',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='【TVPP】Hyorin(SISTAR) - Fate, 효린(씨스타) -인연 @ I Am a Singer 3',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    ...
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title="Fate/stay night Movie: Heaven's Feel『Official MV』", 'Worlds Most Epic Music - Fate',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')]),
                    ...
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/Iw6MK9_yUcw/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIZCGAE=&amp;rs=AOn4CLCyRMQkUnLSikVvSSVDX6ULjnBs7w',title='Top 10 Epic Fate Anime Fights [60FPS]',text='月前',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=yqcn3n0BbE4')])
                ]
            )
        )
        line_bot_api.reply_message(event.reply_token,carousel_template_message)
