...
######################################################################
    ...
    if event.message.text.lower().startswith('測')==True:
        carousel_template_message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(thumbnail_image_url='https://i.ytimg.com/vi/5ecQJhhH2rc/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIhCGAE=&amp;rs=AOn4CLBfYYHtRK2QL5GSbhqQjJrKUPFPeQ',title='Fate Stay Night   Unlimited BladeUnlimit',text='中国云南卫视官方频道 China Yunnan TV Official Channel',actions=[URITemplateAction(label='開始觀看',uri='https://www.youtube.com/watch?v=5ecQJhhH2rc')]),
